                    ...
                    <tr>
                      <td valign="top">
                        <table border="0" cellspacing="0" cellpadding="0" align="left" role="presentation" style="mso-table-lspace:0pt; mso-table-rspace:0pt;">
                          <tr>
                            <td style="padding-top: 5px; font-size: 14px; font-family: Roboto, 'Open Sans', Arial, Tahoma, Helvetica, sans-serif; color: #333333; font-weight: 300; word-break: break-word; line-height: 140%;" align="left"><span style="color: #333333; font-style: normal; line-height: 24px; font-size: 14px; font-weight: 300; font-family: Roboto, 'Open Sans', Arial, Tahoma, Helvetica, sans-serif;">Hi {Name of User},<br><br>A new video of the day has been posted to your training site. <span style="font-style: normal; color: #333333; line-height: 24px; font-size: 14px; font-weight: 700; font-family: Roboto, 'Open Sans', Arial, Tahoma, Helvetica, sans-serif;">Please click this link to watch the video - </span>:<br><br>- <a href="https://sample-link.com" style="color: inherit; border-style: none; text-decoration: none !important; font-size: 14px; font-weight: 300; font-family: Roboto, 'Open Sans', Arial, Tahoma, Helvetica, sans-serif;" border="0">{Title of the Video of the Day}</a><br><br><br>Feel free to email us at <a href="mailto:admin@webinarinc.com" style="color: inherit; border-style: none; text-decoration: none !important; font-size: 14px; font-weight: 300; font-family: Roboto, 'Open Sans', Arial, Tahoma, Helvetica, sans-serif;" border="0">admin@webinarinc.com</a>&nbsp;if you have any questions.<br><br>Thanks!<br>Gilbert Jacob<br><br><br></span></td>
                          </tr>
                        </table>
                      </td>
