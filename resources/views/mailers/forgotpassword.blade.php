                  ...
                  <tr>
                    <td valign="top">
                      <table border="0" cellspacing="0" cellpadding="0" align="left" role="presentation" style="mso-table-lspace:0pt; mso-table-rspace:0pt;">
                        <tr>
                          <td style="padding-top: 5px; font-size: 14px; font-family: Roboto, 'Open Sans', Arial, Tahoma, Helvetica, sans-serif; color: #333333; font-weight: 300; word-break: break-word; line-height: 1;" align="left"><span style="color: #333333; font-style: normal; text-align: left; line-height: 24px; font-size: 14px; font-weight: 300; font-family: Roboto, 'Open Sans', Arial, Tahoma, Helvetica, sans-serif;"><span style="font-style: normal; text-align: left; color: #333333; line-height: 24px; font-size: 14px; font-weight: 300; font-family: Roboto, 'Open Sans', Arial, Tahoma, Helvetica, sans-serif;">Hi {{ $name }},<br><br>We have received a request to reset your password, if you made this request, please click the button below:<br><br>
                                <span style="background-color: #ffb647; border-radius: 10px;text-align: center; padding: 10px; width: 200px; cursor: pointer; margin-top: 20px;"><a href="{{ $link }}" target="_blank">Reset your Password</a></span>
                                <br><br>If you have not requested to reset your password, please ignore this email.&nbsp;<br><br>Feel free to email us at <a href="mailto:admin@webinarinc.com" style="border-style: none; text-decoration: none !important; line-height: 24px; font-size: 14px; font-weight: 300; font-family: Roboto, 'Open Sans', Arial, Tahoma, Helvetica, sans-serif;" border="0">admin@webinarinc.com</a>&nbsp;if you have any questions.<br><br>Thanks!<br>Gilbert Jacob<br><br><br></span></span></td>
                        </tr>
                      </table>
                    </td>
