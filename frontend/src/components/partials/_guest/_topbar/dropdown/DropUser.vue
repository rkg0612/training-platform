<template>
  <div>
    ...
    >
      ...
      <div class="kt-user-card__name" @click="onClickButton()">User</div>
    </div>
    <!--end: Head -->
...
export default {
  ...
  computed: {
    displayProfilePicture() {
      return 'https://webinarinc-v2-development.s3-us-west-2.amazonaws.com/default/default_profile_picture.jpg';
    },
  },
  methods: {
    logout() {
